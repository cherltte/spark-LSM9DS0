Adafruit LSM9DS0 Library for Spark Core
========================

NOTE: The SPI option does not work for this library

The Adafruit Sensor library is also included for ease of usage on the Spark Web IDE.

This should be separated when cross-library usage is made easier in future.

Ported over to Spark by @kennethlimcp on 28 October 2014
